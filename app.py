...
def neo4j_vector_search(question):
  vector_search_query = """
    WITH genai.vector.encode(
      $question,
      "VertexAI",{
      token: "ya29.a0Ad52N38QzHfG1jBkxIQ75MLP967yHdPyPUie5lwTQTJeouRd-H5vmRHwUWDOktGhksp7BCEbOOKLR_HciBS2Mwasr-d71IeRVvLdUQOX-ZEE24ggH4cgHIdxLKEiqkWqx87xYeIA69M4efxQUgZoXApIe8IGbXzYoW8sXqcw1cQaCgYKAfsSARASFQHGX2MiQvG2hCBackqJfsqwd4kc0w0178", 
      projectId: 'mimetic-design-418015'
      })
...
Helpful Answer:"""
        ...
        response = interview(
            temperature=0.0,
            project_id='mimetic-design-418015',
